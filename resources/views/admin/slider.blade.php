                                    ...
                                    <form action="{{url("admin")}}/slider/image/add" method="post" class="needs-validation was-validated" enctype="multipart/form-data" novalidate="">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" name="title" class="form-control position-relative" id="validationTooltip01"  placeholder="عنوان پکیج" value="@if(isset($image->title)){{$image->title}}@endif" required>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($images as $image)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$image->title}}</td>
                                            <td><a href="{{url("admin")}}/slider/image/delete/{{$image->id}}" class="btn btn-icon btn-danger mr-1"><i class="ft-trash"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>

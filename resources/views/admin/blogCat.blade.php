    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">افزودن  دسته بندی بلاگ جدید</h3>
            </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($categories as $b)
                                ...
                                <tr>
                                    <td>{{$i}}</td>
                                    <td>{{$b->name}}</td>
                                    <td><a href="{{url("admin")}}/blog/category/delete/{{$b->id}}" class="btn btn-icon btn-danger mr-1"><i class="ft-trash"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>

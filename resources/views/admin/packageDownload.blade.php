    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">افزودن پکیج دانلودی جدید</h3>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="card-body">
                            @if(!isset($package))
                            <form action="{{url("admin")}}/package/download/add" method="post" class="needs-validation was-validated" novalidate="">
                                @else
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="validationTooltip02">تعداد دانلود</label>
                                        <input type="text" name="count" class="form-control position-relative" id="validationTooltip02" placeholder="تعداد دانلود" value="@if(isset($package->count)){{$package->count}}@endif" required="">
                                        <div class="valid-tooltip">
                                            به نظر خوب میاد!
                                        </div>
                                    </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($packages as $package)
                                ...
                                <tr>
                                    ...
                                    <td>{{$package->count}}</td>
                                    <td>{{$package->link}}</td>
                                    <td><a href="{{url("admin")}}/package/download/update/{{$package->id}}" class="btn btn-icon btn-success mr-1"><i class="ft-edit"></i></a></td>

    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">افزودن بلاگ جدید</h3>
            </div>
                            ...
                            <form action="{{url("admin")}}/blog/add" method="post" class="needs-validation was-validated" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="desc" class="form-control position-relative" id="validationTooltip02" placeholder="توضیحات" value="@if(isset($blog->desc)){{$blog->desc}}@endif" required="">
                                        <div class="valid-tooltip">
                                            به نظر خوب میاد!
                                        </div>
                                    </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($blogs as $b)
                                ...
                                <tr>
                                    ...
                                    <td>{{$b->desc}}</td>
                                    <td>{{$b->category}}</td>
                                    <td><a href="{{url("admin")}}/blog/update/{{$b->id}}" class="btn btn-icon btn-success mr-1"><i class="ft-edit"></i></a></td>
                                    <td><a href="{{url("admin")}}/blog/delete/{{$b->id}}" class="btn btn-icon btn-danger mr-1"><i class="ft-trash"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>

                    ...
                    <div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="index.html" novalidate>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="user-name" name="phone" placeholder="شماره همراه" required>
                                ...
                                <p class="card-subtitle text-muted text-right font-small-3 mx-2 my-1"><span>حساب کاربری ندارید؟ <a href="{{url("/register")}}" class="card-link">ثبت نام</a></span></p>
                            </div>
                            </form>
                        </div>
                    </div>
